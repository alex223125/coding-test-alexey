          ...
          <v-card>
            ...
            <v-card-text>
              <v-container>
                <v-row>
                  <v-col cols="12" sm="6" md="4">
                    <v-text-field readonly="true" v-model="report.title" label="Title"></v-text-field>
                  </v-col>
                  <v-col cols="12" sm="6" md="4">
                    <v-text-field readonly="true" v-model="report.link" label="Link"></v-text-field>
                  </v-col>
                  <v-col cols="12" readonly="true" sm="6" md="4">
                    <v-text-field v-model="report.source" label="Source"></v-text-field>
                  </v-col>
                  <v-col cols="12" readonly="true" sm="6" md="4">
                    <v-text-field v-model="report.version" label="Version"></v-text-field>
                  </v-col>
                </v-row>
              </v-container>
            </v-card-text>
